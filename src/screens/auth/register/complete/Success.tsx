...
const RegisterSuccessScreen: React.FC<RegistrationStackScreenProps<"Register Success">> = () => {
  const dispatch = useTypedDispatch();

  const onSubmit = async function () {
    dispatch(authSliceActions.completeOnboarding());
  };
          ...
          <View style={tw`p-4 h-1/2 justify-end`}>
            <View>
              ...
              <Text style={tw`leading-6 w-full font-light text-base text-gray text-center`}>
                Congratulations! Your registration is complete. Proceed to your home screen to start exploring BinaPay.
              </Text>
            </View>
          </View>
        </View>
